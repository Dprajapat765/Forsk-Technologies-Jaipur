...
'''
1. file load error -- encoding problem
    use sublime text -> view -> show console

2. blanks problem 
    use map functionality and apply fuction 
    handle missing values 

3. read the data set

4. convert the column name in the single name
